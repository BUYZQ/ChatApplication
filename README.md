...
# Данный проект я делал для в Августе 2024 года для того, чтобы посмотреть, как работать с Firebase, посмотреть его основные сервисы и конечно же это было хороший практикой, в применение базы данных в приложении